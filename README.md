...
3. Stores everything — form data, uploaded documents, signature, generated PDF — in Insforge (self-hosted Postgres + S3-compatible storage). No Bitrix, no other CRM.
